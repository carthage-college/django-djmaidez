...
# python
sys.path.append('/d2/python_venv/3.6/djmaidez/lib/python3.6/')
sys.path.append('/d2/python_venv/3.6/djmaidez/lib/python3.6/site-packages/')
# django
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'djmaidez.settings.staging')
